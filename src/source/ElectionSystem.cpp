...
void ElectionSystem::addCandidate() {
    ...
    Candidate newCandidate(id, name, partyAffiliation);
...
void ElectionSystem::displayAdminMenu() const {
    std::cout << "\n=== Admin Menu ===" << std::endl;
    std::cout << "1. Create Election" << std::endl;
    std::cout << "2. Manage Elections" << std::endl;
    std::cout << "3. Add Candidate" << std::endl;
    std::cout << "4. View Elections Results" << std::endl;
    std::cout << "5. Register Voter" << std::endl;
    std::cout << "6. Manage Users" << std::endl;
    std::cout << "7. Logout" << std::endl;
    std::cout << "Enter your choice: ";
}

void ElectionSystem::displayVoterMenu() const {
    std::cout << "\n=== Voter Menu ===" << std::endl;
    std::cout << "1. View Available Elections" << std::endl;
    std::cout << "2. Cast Vote" << std::endl;
    std::cout << "3. View My Voting Status" << std::endl;
        ...
        if (!isLoggedIn()) {
            ...
            if (isAdmin()) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    // View voting status functionality
                    break;
                case 4:
                    logout();
                    break;
